...
namespace Pronia.Migrations
{
    ...
    [Migration("20260109061319_BasketTableAdded")]
            ...
            modelBuilder.Entity("Pronia.Models.Basket", b =>
                {
                    ...
                    b.ToTable("Baskets", t =>
                        {
                            t.HasCheckConstraint("CK_Basket_Count_NonNegative", "[Count] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("Pronia.Models.Slider", b =>
                {
                    ...
                    b.ToTable("Sliders", t =>
                        {
                            t.HasCheckConstraint("CK_Slider_DiscountPercentage", "[DiscountPercentage] >= 0 AND [DiscountPercentage] <= 100");
                        });
                });
